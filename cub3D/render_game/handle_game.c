...
/*   Updated: 2021/04/22 00:41:10 by ngregori         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int    render_next_frame(t_game *game)
{
	...
	game->main_img.img = mlx_new_image(game->vars.mlx, game->settings.res->width, game->settings.res->height);
...
void    render_game(t_game *game)
{
	...
	game->vars.win = mlx_new_window(game->vars.mlx, game->settings.res->width, game->settings.res->height, "CUB3D");
	game->cube_size = 64;
